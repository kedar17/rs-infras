    ...
    <div class="container my-5">
        <div class="proposal-container">
            <div class="header-bar">
                <h1 class="h3 mb-0"><i class="fas fa-file-alt me-2"></i><b>Edit Proposal</b></h1>
            </div>
            ...
            <form action="{{ route('proposals.update', $proposal) }}" method="POST">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" name="date" class="form-control" value="{{ old('date', $proposal->date) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="reference" class="form-control" value="{{ old('reference', $proposal->reference) }}" maxlength="255" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="client_name" class="form-control" value="{{ old('client_name', $proposal->client_name) }}" maxlength="255" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="client_address" class="form-control" rows="3" required>{{ old('client_address', $proposal->client_address) }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="subject" class="form-control" value="{{ old('subject', $proposal->subject) }}" maxlength="255" required>
                ...
                <div class="mb-4">
                    ...
                    <div class="editor-container">
                        ...
                        <div class="rich-editor" contenteditable="true" id="body-intro-editor">{!! old('body_intro', $proposal->body_intro) !!}</div>
                        <textarea name="body_intro" class="d-none" id="body-intro-textarea" required>{{ old('body_intro', $proposal->body_intro) }}</textarea>
                    </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" name="price_total" class="form-control" value="{{ old('price_total', $proposal->price_total) }}" min="0" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="price_gst_percent" class="form-control" value="{{ old('price_gst_percent', $proposal->price_gst_percent) }}" min="0" max="100" required>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="price_in_words" class="form-control" value="{{ old('price_in_words', $proposal->price_in_words) }}" maxlength="255" required>
                ...
                <div class="mb-4">
                    <div class="editor-container">
                        ...
                        <div class="rich-editor" contenteditable="true" id="scope-editor">{!! old('scope_of_work', $proposal->scope_of_work) !!}</div>
                        <textarea name="scope_of_work" class="d-none" id="scope-textarea" required>{{ old('scope_of_work', $proposal->scope_of_work) }}</textarea>
                    </div>
                ...
                <div class="mb-4">
                    <div class="editor-container">
                        ...
                        <div class="rich-editor" contenteditable="true" id="warranty-editor">{!! old('warranty', $proposal->warranty) !!}</div>
                        <textarea name="warranty" class="d-none" id="warranty-textarea" required>{{ old('warranty', $proposal->warranty) }}</textarea>
                    </div>
                ...
                <div class="mb-4">
                    <div class="editor-container">
                        ...
                        <div class="rich-editor" contenteditable="true" id="payment-editor">{!! old('payment_schedule', $proposal->payment_schedule) !!}</div>
                        <textarea name="payment_schedule" class="d-none" id="payment-textarea" required>{{ old('payment_schedule', $proposal->payment_schedule) }}</textarea>
                    </div>
                ...
                <div class="mb-4">
                    <div class="editor-container">
                        ...
                        <div class="rich-editor" contenteditable="true" id="notes-editor">{!! old('notes', $proposal->notes) !!}</div>
                        <textarea name="notes" class="d-none" id="notes-textarea">{{ old('notes', $proposal->notes) }}</textarea>
                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="signatory_name" class="form-control" value="{{ old('signatory_name', $proposal->signatory_name) }}" maxlength="255" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="signatory_role" class="form-control" value="{{ old('signatory_role', $proposal->signatory_role) }}" maxlength="255" required>
                ...
                <div class="d-flex justify-content-end mt-5">
                    <a href="{{ route('proposals') }}" class="btn btn-secondary me-3">Cancel</a>
